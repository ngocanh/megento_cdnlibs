 ...
 * @link      https://github.com/ngocanh/ngocanh_mage_cdnlibs
 */
class NgocAnh_CdnLibs_Model_System_Config_Cdn_Jquery extends NgocAnh_CdnLibs_Model_System_Config
{
    /**
    ...
    protected $_jQueryMapping = array(
        NgocAnh_CdnLibs_Model_System_Config_Source_Cdn_Resource::OPTION_VALUE_GOOGLE => array(
        ...
        NgocAnh_CdnLibs_Model_System_Config_Source_Cdn_Resource::OPTION_VALUE_MICROSOFT => array(
        ...
        NgocAnh_CdnLibs_Model_System_Config_Source_Cdn_Resource::OPTION_VALUE_JQUERY => array(
     ...
     *
     * @var array
     * @see NgocAnh_CdnLibs_Model_System_Config::_init()
     */
    ...
    public function getCoreUri()
    {
        if (!($coreUri = $this->getData(self::SYSTEM_CONFIG_KEY_JQUERY_CORE . '/uri'))) {
            ...
            if ($cdnResourceId > NgocAnh_CdnLibs_Model_System_Config_Source_Cdn_Resource::OPTION_VALUE_CUSTOM) {
    ...
    public function getUiThemeUri()
    {
        if (!($uiThemeUri = $this->getData(self::SYSTEM_CONFIG_KEY_JQUERY_UI . '/theme_uri'))) {
            ...
            if ($cdnResourceId > NgocAnh_CdnLibs_Model_System_Config_Source_Cdn_Resource::OPTION_VALUE_JQUERY) {
                $resource = Mage::getSingleton('cdnlibs_source/cdn_resource')
                    ->getResource($cdnResourceId);
