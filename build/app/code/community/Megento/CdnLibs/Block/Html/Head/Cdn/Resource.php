 ...
 * @link      https://github.com/ngocanh/megento_cdnlibs
 */
class Megento_CdnLibs_Block_Html_Head_Cdn_Resource extends Mage_Core_Block_Template
{
    /**
     ...
     *
     * @var Megento_CdnLibs_Model_System_Config_Cdn_Jquery
     */
     ...
     * @var string
     */
    protected $_template = 'megento/cdnlibs/html/head/cdn/resource.phtml';

    /**
     * helper to add protocol to each resource and generating a valid URL
     *
     * @var Megento_CdnLibs_Helper_ExternalUrl
     */
     ...
     *  </i>
     *
     * @return Megento_CdnLibs_Block_Html_Head_Cdn_Resource
     */
     ...
     *
     * @return Megento_CdnLibs_Model_System_Config_Cdn_Jquery
     */
    ...
    /**
     * jQuery shortcut - default is <i>$j</i>.
     *
     ...
     *
     * @return Megento_CdnLibs_Helper_ExternalUrl
     */
